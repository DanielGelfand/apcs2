...
public class LList<T> implements List<T>
{
  ...
  *****************************************************/
  private class MyIterator implements Iterator<T>
  {
    ...
    {
      //System.out.println((_dummy.getNext() != null));
    ...
    public void remove()
    {
      ...
      //if dummy and _head point to same place removeFirst()...

      if (_dummy==_head) {
        _okToRemove = false;
        removeFirst();
      }
      //if dummy points to tail remove last...
      ...
      //
      //
      //otherwise rearrange the pinters and remove curr node(_dummy)...
      else {
        T retVal = _dummy.getCargo();
        //reset pointers
